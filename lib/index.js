...
/* eslint no-unused-vars: "off" */
var AllowMessagesFromGroup = (function () {
  var hasError = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

  return {
    postMessage: function postMessage(params) {
      VKWebAppEvent(!hasError ? response.VKWebAppAllowMessagesFromGroup.data : response.VKWebAppAllowMessagesFromGroup.errorData);
    }
  };
});
...
var allowMessagesFromGroupData = {
...
var allowMessagesFromGroupDataError = {
